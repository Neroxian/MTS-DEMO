  ...
  <div class="main">
    ...
    <div>
      ...
      <div class="row">
        <div class="px-2 col-6">
          <b-form-group id="input-group-1" label="Filter :" label-for="input-1">
            <b-form-select
              v-model="searchBy"
    ...
    <div class="transport-detail card-box mt-4" v-if="transportMode !== ''">
      <b-form>
        ...
        <div class="transport-form mt-3 byPost" v-if="transportMode == 'By Post'">
          <h4 class="bg-light p-1">Enter Details</h4>
          <b-form-group
            label="ERP No:"
            label-for="contact"
        ...
        <div class="transport-form mt-3 byHand" v-if="transportMode == 'By Hand'">
          <h4 class="bg-light p-1">Enter Details</h4>
          <b-form-group
            label="Description:"
            label-for="contact"
        ...
        <div class="d-flex justify-content-center mt-2">
          ...
          >
            <b-form-datepicker id="input-8" v-model="value"></b-form-datepicker>
          </b-form-group>
        </div>
